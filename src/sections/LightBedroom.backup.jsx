...
// Personal Command Center - Multi-functional workspace
...
export default function LightBedroom({ onToggleMode }) {
  ...
  const [notes, setNotes] = useState([
    { id: 1, title: "Bitcoin Basics", content: "Key takeaways from today's lecture...", date: "Dec 19", pinned: true },
    { id: 2, title: "Smart Contract Ideas", content: "Potential use cases to explore...", date: "Dec 18", pinned: false },
  ]);
  const [savedItems, setSavedItems] = useState([
    { id: 1, title: "DeFi Tutorial Series", type: "video", url: "#" },
    { id: 2, title: "Tokenomics Guide", type: "article", url: "#" },
    { id: 3, title: "NFT Marketplace Code", type: "code", url: "#" },
  ]);
  ...
  const [resources] = useState([
    { id: 1, title: "Ethereum Developer Docs", category: "documentation", url: "https://ethereum.org/developers" },
    { id: 2, title: "Coinbase Learn", category: "tutorial", url: "https://coinbase.com/learn" },
    { id: 3, title: "CryptoZombies", category: "interactive", url: "https://cryptozombies.io" },
    { id: 4, title: "Web3 University", category: "course", url: "https://web3.university" },
  ]);
