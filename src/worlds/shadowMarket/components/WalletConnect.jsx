  ...
  if (connected) {
    return (
      <div className="flex items-center gap-4">
        <div className="bg-black/40 backdrop-blur-xl border border-purple-500/20 rounded-xl px-6 py-3 flex items-center gap-4">
  ...
  return (
    <>
      <button
        ...
        className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-semibold rounded-xl shadow-[0_0_30px_rgba(168,85,247,0.4)] transition-all"
      >
        Connect Wallet
      </button>
        ...
        {showModal && (
          ...
          >
            <motion.div
              ...
              className="bg-gradient-to-br from-slate-900 to-purple-900 border border-purple-500/30 rounded-2xl p-8 max-w-md w-full shadow-[0_0_60px_rgba(168,85,247,0.3)]"
            >
